  ...
  <div class="ui inverted vertical masthead center aligned segment">
    ...
    <div class="ui container">
      <div class="ui large secondary inverted pointing menu">
        ...
        <a href="./userIndex" class="item">所有书籍</a>
        <a href="./userRecord" class="active item">借还记录</a>
    ...
    <s:iterator value="records" var="r">
    	<s:if test='"B".equals(category)'>
			<tr>
				...
				<td>借阅</td>
				<td><a href="${pageContext.request.contextPath}/returnbook?id=${r.id}">归还</a></td>
			</tr>
		</s:if>
		<s:if test='"R".equals(category)'>
			<tr>
				<td>
				<h4 class="ui image header">
            	<div class="content">
